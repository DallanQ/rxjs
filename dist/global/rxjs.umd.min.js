...
d[e]=null;this.onSettledCallbacks_=null}};var x=new d;h.prototype.settleSameAsPromise_=function(d){var e=this.createResolveAndReject_();d.callWhenSettled_(e.resolve,e.reject)};h.prototype.settleSameAsThenable_=function(d,e){var n=this.createResolveAndReject_();try{d.call(e,n.resolve,n.reject)}catch(z){n.reject(z)}};h.prototype.then=function(d,e){function n(d,e){return"function"==typeof d?function(e){try{l(d(e))}catch(I){m(I)}}:e}var l,m,P=new h(function(d,e){l=d;m=e});this.callWhenSettled_(n(d,l),
n(e,m));return P};h.prototype.catch=function(d){return this.then(void 0,d)};h.prototype.callWhenSettled_=function(d,e){function n(){switch(h.state_){case 1:d(h.result_);break;case 2:e(h.result_);break;default:throw Error("Unexpected state: "+h.state_);}}var h=this;null==this.onSettledCallbacks_?x.asyncExecute(n):this.onSettledCallbacks_.push(function(){x.asyncExecute(n)})};h.resolve=function(d){return d instanceof h?d:new h(function(e,n){e(d)})};h.reject=function(d){return new h(function(e,n){n(d)})};
...
d.value]})};l.prototype.keys=function(){return x(this,function(d){return d.key})};l.prototype.values=function(){return x(this,function(d){return d.value})};l.prototype.forEach=function(d,e){for(var h=this.entries(),l;!(l=h.next()).done;)l=l.value,d.call(e,l[1],l[0],this)};l.prototype[Symbol.iterator]=l.prototype.entries;var h=function(e,h){var l;l=h&&typeof h;"object"==l||"function"==l?d.has(h)?l=d.get(h):(l=""+ ++P,d.set(h,l)):l="p_"+h;var m=e.data_[l];if(m&&$jscomp.owns(e.data_,l))for(e=0;e<m.length;e++){var n=
m[e];if(h!==h&&n.key!==n.key||h===n.key)return{id:l,list:m,index:e,entry:n}}return{id:l,list:m,index:-1,entry:void 0}},x=function(d,e){var h=d.head_;return $jscomp.iteratorPrototype(function(){if(h){for(;h.head!=d.head_;)h=h.previous;for(;h.next!=h.head;)return h=h.next,{done:!1,value:e(h)};h=null}return{done:!0,value:void 0}})},m=function(){var d={};return d.previous=d.next=d.head=d},P=0;return l},"es6-impl","es3");$jscomp.array=$jscomp.array||{};
...
(function(e,d){"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(e.rxjs=e.rxjs||{})})(this,function(e){function d(c,a){function b(){this.constructor=c}Pb(c,a);c.prototype=null===a?Object.create(a):(b.prototype=a.prototype,new b)}function l(c){return"function"===typeof c}function h(c){setTimeout(function(){throw c;})}function x(){try{return Na.apply(this,arguments)}catch(c){return p.e=c,p}}function m(c){Na=c;return x}function P(c){Error.call(this);
this.message=c?c.length+" errors occurred during unsubscription:\n"+c.map(function(a,b){return b+1+") "+a.toString()}).join("\n  "):"";this.name="UnsubscriptionError";this.errors=c;return this}function n(c){return c.reduce(function(a,b){return a.concat(b instanceof ea?b.errors:b)},[])}function z(){}function N(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return Ma(c)}function Ma(c){return c?1===c.length?c[0]:function(a){return c.reduce(function(b,a){return a(b)},a)}:z}function sa(c){c||
(c=H.Promise||Promise);if(!c)throw Error("no Promise impl found");return c}function J(){Error.call(this);this.message="object unsubscribed";this.name="ObjectUnsubscribedError";return this}function ta(){return function(c){return c.lift(new Qb(c))}}function I(c){return c?Rb(c):Q}function Rb(c){return new r(function(a){return c.schedule(function(){return a.complete()})})}function C(c){return c&&"function"===typeof c.schedule}function K(c,a){return a?new r(function(b){var f=new w,g=0;f.add(a.schedule(function(){g===
c.length?b.complete():(b.next(c[g++]),b.closed||f.add(this.schedule()))}));return f}):new r(Oa(c))}function ua(c){var a=new r(function(b){b.next(c);b.complete()});a._isScalar=!0;a.value=c;return a}function va(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];a=c[c.length-1];C(a)?c.pop():a=void 0;switch(c.length){case 0:return I(a);case 1:return a?K(c,a):ua(c[0]);default:return K(c,a)}}function wa(c,a){return a?new r(function(b){return a.schedule(Sb,0,{error:c,subscriber:b})}):new r(function(b){return b.error(c)})}
function Sb(c){c.subscriber.error(c.error)}function R(c){return c}function S(){Error.call(this);this.message="argument out of range";this.name="ArgumentOutOfRangeError";return this}function Pa(){Error.call(this);this.message="no elements in sequence";this.name="EmptyError";return this}function xa(){Error.call(this);this.message="Timeout has occurred";this.name="TimeoutError";return this}function G(c,a){return function(b){if("function"!==typeof c)throw new TypeError("argument is not a function. Are you looking for `mapTo()`?");
return b.lift(new Tb(c,a))}}function Qa(c,a,b){if(a)if(C(a))b=a;else return function(){for(var f=[],g=0;g<arguments.length;g++)f[g]=arguments[g];return Qa(c,b).apply(void 0,f).pipe(G(function(b){return E(b)?a.apply(void 0,b):a(b)}))};return function(){for(var a=[],g=0;g<arguments.length;g++)a[g]=arguments[g];var k=this,d,e={context:k,subject:d,callbackFunc:c,scheduler:b};return new r(function(f){if(b)return b.schedule(Ub,0,{args:a,subscriber:f,params:e});if(!d){d=new Z;try{c.apply(k,a.concat([function(){for(var b=
[],a=0;a<arguments.length;a++)b[a]=arguments[a];d.next(1>=b.length?b[0]:b);d.complete()}]))}catch(za){d.error(za)}}return d.subscribe(f)})}}function Ub(c){var a=this,b=c.args,f=c.subscriber;c=c.params;var g=c.callbackFunc,k=c.context,d=c.scheduler,e=c.subject;if(!e){e=c.subject=new Z;try{g.apply(k,b.concat([function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];a.add(d.schedule(Vb,0,{value:1>=b.length?b[0]:b,subject:e}))}]))}catch(T){e.error(T)}}this.add(e.subscribe(f))}function Vb(c){var a=
c.subject;a.next(c.value);a.complete()}function Ra(c,a,b){if(a)if(C(a))b=a;else return function(){for(var f=[],g=0;g<arguments.length;g++)f[g]=arguments[g];return Ra(c,b).apply(void 0,f).pipe(G(function(b){return E(b)?a.apply(void 0,b):a(b)}))};return function(){for(var a=[],g=0;g<arguments.length;g++)a[g]=arguments[g];var k={subject:void 0,args:a,callbackFunc:c,scheduler:b,context:this};return new r(function(f){var g=k.context,d=k.subject;if(b)return b.schedule(Wb,0,{params:k,subscriber:f,context:g});
if(!d){d=k.subject=new Z;try{c.apply(g,a.concat([function(){for(var b=[],a=0;a<arguments.length;a++)b[a]=arguments[a];(a=b.shift())?d.error(a):(d.next(1>=b.length?b[0]:b),d.complete())}]))}catch(za){d.error(za)}}return d.subscribe(f)})}}function Wb(c){var a=this,b=c.params,f=c.subscriber;c=c.context;var g=b.callbackFunc,k=b.args,d=b.scheduler,e=b.subject;if(!e){e=b.subject=new Z;try{g.apply(c,k.concat([function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];(c=b.shift())?a.add(d.schedule(Sa,
0,{err:c,subject:e})):a.add(d.schedule(Xb,0,{value:1>=b.length?b[0]:b,subject:e}))}]))}catch(T){this.add(d.schedule(Sa,0,{err:T,subject:e}))}}this.add(e.subscribe(f))}function Xb(c){var a=c.subject;a.next(c.value);a.complete()}function Sa(c){c.subject.error(c.err)}function Ta(c){return c&&"function"!==typeof c.subscribe&&"function"===typeof c.then}function u(c,a,b,f,g){void 0===g&&(g=new Ua(c,b,f));if(!g.closed)return Va(a)(g)}function Yb(c,a){return a?new r(function(b){var f=new w;f.add(a.schedule(function(){return c.then(function(c){f.add(a.schedule(function(){b.next(c);
f.add(a.schedule(function(){return b.complete()}))}))},function(c){f.add(a.schedule(function(){return b.error(c)}))})}));return f}):new r(Wa(c))}function Zb(c,a){if(!c)throw Error("Iterable cannot be null");return a?new r(function(b){var f=new w,g;f.add(function(){g&&"function"===typeof g.return&&g.return()});f.add(a.schedule(function(){g=c[L]();f.add(a.schedule(function(){if(!b.closed){var a,c;try{var f=g.next();a=f.value;c=f.done}catch(T){b.error(T);return}c?b.complete():(b.next(a),this.schedule())}}))}));
return f}):new r(Xa(c))}function $b(c,a){return a?new r(function(b){var f=new w;f.add(a.schedule(function(){var g=c[aa]();f.add(g.subscribe({next:function(c){f.add(a.schedule(function(){return b.next(c)}))},error:function(c){f.add(a.schedule(function(){return b.error(c)}))},complete:function(){f.add(a.schedule(function(){return b.complete()}))}}))}));return f}):new r(Ya(c))}function M(c,a){if(!a)return c instanceof r?c:new r(Va(c));if(null!=c){if(c&&"function"===typeof c[aa])return $b(c,a);if(Ta(c))return Yb(c,
a);if(Za(c))return K(c,a);if(c&&"function"===typeof c[L]||"string"===typeof c)return Zb(c,a)}throw new TypeError((null!==c&&typeof c||c)+" is not observable");}function U(c,a,b){void 0===b&&(b=Number.POSITIVE_INFINITY);if("function"===typeof a)return function(f){return f.pipe(U(function(b,f){return M(c(b,f)).pipe(G(function(c,g){return a(b,c,f,g)}))},b))};"number"===typeof a&&(b=a);return function(a){return a.lift(new ac(c,b))}}function Aa(c){void 0===c&&(c=Number.POSITIVE_INFINITY);return U(R,c)}
function $a(){return Aa(1)}function O(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return 1===c.length||2===c.length&&C(c[1])?M(c[0]):$a()(va.apply(void 0,c))}function Ba(c){return new r(function(a){var b;try{b=c()}catch(f){a.error(f);return}return(b?M(b):I()).subscribe(a)})}function ab(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var b;"function"===typeof c[c.length-1]&&(b=c.pop());1===c.length&&E(c[0])&&(c=c[0]);return 0===c.length?Q:b?ab(c).pipe(G(function(a){return b.apply(void 0,
a)})):new r(function(b){return new bc(b,c)})}function bb(c,a,b,f){l(b)&&(f=b,b=void 0);return f?bb(c,a,b).pipe(G(function(b){return E(b)?f.apply(void 0,b):f(b)})):new r(function(f){cb(c,a,function(b){1<arguments.length?f.next(Array.prototype.slice.call(arguments)):f.next(b)},f,b)})}function cb(c,a,b,f,g){var k;if(c&&"function"===typeof c.addEventListener&&"function"===typeof c.removeEventListener)c.addEventListener(a,b,g),k=function(){return c.removeEventListener(a,b,g)};else if(c&&"function"===typeof c.on&&
"function"===typeof c.off)c.on(a,b),k=function(){return c.off(a,b)};else if(c&&"function"===typeof c.addListener&&"function"===typeof c.removeListener)c.addListener(a,b),k=function(){return c.removeListener(a,b)};else if(c&&c.length)for(var d=0,e=c.length;d<e;d++)cb(c[d],a,b,f,g);else throw new TypeError("Invalid event target");f.add(k)}function db(c,a,b){return b?db(c,a).pipe(G(function(a){return E(a)?b.apply(void 0,a):b(a)})):new r(function(b){var f=function(){for(var a=[],c=0;c<arguments.length;c++)a[c]=
arguments[c];return b.next(1===a.length?a[0]:a)},k;try{k=c(f)}catch(B){b.error(B);return}if(l(a))return function(){return a(f,k)}})}function cc(c){var a=c.subscriber,b=c.condition;if(!a.closed){if(c.needIterate)try{c.state=c.iterate(c.state)}catch(k){a.error(k);return}else c.needIterate=!0;if(b){var f=void 0;try{f=b(c.state)}catch(k){a.error(k);return}if(!f){a.complete();return}if(a.closed)return}var g;try{g=c.resultSelector(c.state)}catch(k){a.error(k);return}if(!a.closed&&(a.next(g),!a.closed))return this.schedule(c)}}
function ba(c){return!E(c)&&0<=c-parseFloat(c)+1}function dc(c){var a=c.subscriber,b=c.counter;c=c.period;a.next(b);this.schedule({subscriber:a,counter:b+1,period:c},c)}function eb(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var a=Number.POSITIVE_INFINITY,b=null,f=c[c.length-1];C(f)?(b=c.pop(),1<c.length&&"number"===typeof c[c.length-1]&&(a=c.pop())):"number"===typeof f&&(a=c.pop());return null===b&&1===c.length&&c[0]instanceof r?c[0]:Aa(a)(K(c,b))}function Ca(){for(var c=[],a=0;a<
arguments.length;a++)c[a]=arguments[a];if(0===c.length)return Q;var b=c[0],f=c.slice(1);return 1===c.length&&E(b)?Ca.apply(void 0,b):new r(function(a){var c=function(){return a.add(Ca.apply(void 0,f).subscribe(a))};return M(b).subscribe({next:function(b){a.next(b)},error:c,complete:c})})}function ec(c){var a=c.keys,b=c.index,f=c.subscriber,g=c.subscription;c=c.obj;if(!f.closed)if(b<a.length){var k=a[b];f.next([k,c[k]]);g.add(this.schedule({keys:a,index:b+1,subscriber:f,subscription:g,obj:c}))}else f.complete()}
function fb(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];if(1===c.length)if(E(c[0]))c=c[0];else return c[0];return K(c,void 0).lift(new fc)}function gc(c){var a=c.start,b=c.index,f=c.subscriber;b>=c.count?f.complete():(f.next(a),f.closed||(c.index=b+1,c.start=a+1,this.schedule(c)))}function gb(c,a,b){void 0===c&&(c=0);var f=-1;ba(a)?f=1>Number(a)&&1||Number(a):C(a)&&(b=a);C(b)||(b=D);return new r(function(a){var g=ba(c)?c:+c-b.now();return b.schedule(hc,g,{index:0,period:f,subscriber:a})})}
...
function jc(c){var a=c.bufferCreationInterval,b=c.bufferTimeSpan,f=c.subscriber,g=c.scheduler,k=f.openContext();f.closed||(f.add(k.closeAction=g.schedule(lb,b,{subscriber:f,context:k})),this.schedule(c,a))}function lb(c){c.subscriber.closeContext(c.context)}function mb(c,a){return U(c,a,1)}function kc(c){c.debouncedNext()}function fa(c){void 0===c&&(c=null);return function(a){return a.lift(new lc(c))}}function nb(c,a){return function(b){return b.lift(new mc(c,a))}}function ca(c,a){return function(b){return b.lift(new nc(c,
a))}}function ob(c,a,b){return function(f){return f.lift(new oc(c,a,b))}}function pc(){return new ga}function Da(c){return function(a){return 0===c?I():a.lift(new qc(c))}}function pb(c,a){return a?function(b){return b.pipe(pb(function(b,g){return M(c(b,g)).pipe(G(function(c,f){return a(b,c,g,f)}))}))}:function(b){return b.lift(new rc(c))}}function la(c){return function(a){return 0===c?I():a.lift(new sc(c))}}function ma(c,a){var b=!1;2<=arguments.length&&(b=!0);return function(f){return f.lift(new tc(c,
a,b))}}function na(c,a){return 2<=arguments.length?function(b){return N(ma(c,a),la(1),fa(a))(b)}:function(b){return N(ma(function(b,a,k){return c(b,a,k+1)}),la(1))(b)}}function V(c,a){return function(b){var f;f="function"===typeof c?c:function(){return c};if("function"===typeof a)return b.lift(new uc(f,a));var g=Object.create(b,vc);g.source=b;g.subjectFactory=f;return g}}function wc(c,a){function b(){return!b.pred.apply(b.thisArg,arguments)}b.pred=c;b.thisArg=a;return b}function xc(c,a){return function(b){var f=
b;for(b=0;b<a;b++)if(f=f[c[b]],"undefined"===typeof f)return;return f}}function yc(c){var a=c.period;c.subscriber.notifyNext();this.schedule(c,a)}function zc(){return new y}function Ac(c,a,b){var f,g=0,k,d=!1,e=!1;return function(B){g++;if(!f||d)d=!1,f=new W(c,a,b),k=B.subscribe({next:function(b){f.next(b)},error:function(b){d=!0;f.error(b)},complete:function(){e=!0;f.complete()}});var h=f.subscribe(this);return function(){g--;h.unsubscribe();k&&0===g&&e&&k.unsubscribe()}}}function ha(c,a){return"function"===
typeof a?function(b){return b.pipe(ha(function(b,g){return M(c(b,g)).pipe(G(function(c,f){return a(b,c,g,f)}))}))}:function(b){return b.lift(new Bc(c))}}function Cc(c){c.subscriber.clearThrottle()}function qb(c,a,b){void 0===b&&(b=D);return function(f){var g=c instanceof Date&&!isNaN(+c),k=g?+c-b.now():Math.abs(c);return f.lift(new Dc(k,g,a,b))}}function Ec(c,a,b){if(0===b)return[a];c.push(a);return c}function Fc(c){var a=c.subscriber,b=c.windowTimeSpan,f=c.window;f&&a.closeWindow(f);c.window=a.openWindow();
...
d=0,e=k.length;d<e;d++){var h=k[d];c.prototype[h]=g.prototype[h]}}function Hc(c,a){void 0===a&&(a=null);return new X({method:"GET",url:c,headers:a})}function Ic(c,a,b){return new X({method:"POST",url:c,body:a,headers:b})}function Jc(c,a){return new X({method:"DELETE",url:c,headers:a})}function Kc(c,a,b){return new X({method:"PUT",url:c,body:a,headers:b})}function Lc(c,a,b){return new X({method:"PATCH",url:c,body:a,headers:b})}function Mc(c,a){return Nc(new X({method:"GET",url:c,responseType:"json",
...
a.responseText}}var Pb=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,a){c.__proto__=a}||function(c,a){for(var b in a)a.hasOwnProperty(b)&&(c[b]=a[b])},Pc=Object.assign||function(c){for(var a,b=1,f=arguments.length;b<f;b++){a=arguments[b];for(var g in a)Object.prototype.hasOwnProperty.call(a,g)&&(c[g]=a[g])}return c},Ea=!1,H={Promise:void 0,set useDeprecatedSynchronousErrorHandling(c){c?console.warn("DEPRECATED! RxJS was set to use deprecated synchronous error handling behavior by code at: \n"+
Error().stack):Ea&&console.log("RxJS: Back to a better error behavior. Thank you. \x3c3");Ea=c},get useDeprecatedSynchronousErrorHandling(){return Ea}},oa={closed:!0,next:function(c){},error:function(c){if(H.useDeprecatedSynchronousErrorHandling)throw c;h(c)},complete:function(){}},E=Array.isArray||function(c){return c&&"number"===typeof c.length},p={e:{}},Na;P.prototype=Object.create(Error.prototype);var ea=P,w=function(){function c(a){this.closed=!1;this._subscriptions=this._parents=this._parent=
null;a&&(this._unsubscribe=a)}c.prototype.unsubscribe=function(){var a=!1,b;if(!this.closed){var c=this._parent,g=this._parents,k=this._unsubscribe,d=this._subscriptions;this.closed=!0;this._subscriptions=this._parents=this._parent=null;for(var e=-1,h=g?g.length:0;c;)c.remove(this),c=++e<h&&g[e]||null;l(k)&&(c=m(k).call(this),c===p&&(a=!0,b=b||(p.e instanceof ea?n(p.e.errors):[p.e])));if(E(d))for(e=-1,h=d.length;++e<h;)c=d[e],null!=c&&"object"===typeof c&&(c=m(c.unsubscribe).call(c),c===p&&(a=!0,
b=b||[],c=p.e,c instanceof ea?b=b.concat(n(c.errors)):b.push(c)));if(a)throw new ea(b);}};c.prototype.add=function(a){if(!a||a===c.EMPTY)return c.EMPTY;if(a===this)return this;var b=a;switch(typeof a){case "function":b=new c(a);case "object":if(b.closed||"function"!==typeof b.unsubscribe)return b;if(this.closed)return b.unsubscribe(),b;"function"!==typeof b._addParent&&(a=b,b=new c,b._subscriptions=[a]);break;default:throw Error("unrecognized teardown "+a+" added to Subscription.");}(this._subscriptions||
(this._subscriptions=[])).push(b);b._addParent(this);return b};c.prototype.remove=function(a){var b=this._subscriptions;b&&(a=b.indexOf(a),-1!==a&&b.splice(a,1))};c.prototype._addParent=function(a){var b=this._parent,c=this._parents;b&&b!==a?c?-1===c.indexOf(a)&&c.push(a):this._parents=[a]:this._parent=a};c.EMPTY=function(a){a.closed=!0;return a}(new c);return c}(),da="function"===typeof Symbol&&"function"===typeof Symbol.for?Symbol.for("rxSubscriber"):"@@rxSubscriber",q=function(c){function a(b,
a,g){var f=c.call(this)||this;f.syncErrorValue=null;f.syncErrorThrown=!1;f.syncErrorThrowable=!1;f.isStopped=!1;f._parentSubscription=null;switch(arguments.length){case 0:f.destination=oa;break;case 1:if(!b){f.destination=oa;break}if("object"===typeof b){if(b instanceof q||"syncErrorThrowable"in b&&b[da]){var d=b[da]();f.syncErrorThrowable=d.syncErrorThrowable;f.destination=d;d._addParentTeardownLogic(f)}else f.syncErrorThrowable=!0,f.destination=new vb(f,b);break}default:f.syncErrorThrowable=!0,
f.destination=new vb(f,b,a,g)}return f}d(a,c);a.prototype[da]=function(){return this};a.create=function(b,c,g){b=new a(b,c,g);b.syncErrorThrowable=!1;return b};a.prototype.next=function(b){this.isStopped||this._next(b)};a.prototype.error=function(b){this.isStopped||(this.isStopped=!0,this._error(b),this._unsubscribeParentSubscription())};a.prototype.complete=function(){this.isStopped||(this.isStopped=!0,this._complete(),this._unsubscribeParentSubscription())};a.prototype.unsubscribe=function(){this.closed||
...
c[aa]();if("function"!==typeof b.subscribe)throw new TypeError("Provided object does not correctly implement Symbol.observable");return b.subscribe(a)}},Za=function(c){return c&&"number"===typeof c.length&&"function"!==typeof c},Va=function(c){if(c instanceof r)return function(a){if(c._isScalar)a.next(c.value),a.complete();else return c.subscribe(a)};if(c&&"function"===typeof c[aa])return Ya(c);if(Za(c))return Oa(c);if(Ta(c))return Wa(c);if(c&&"function"===typeof c[L])return Xa(c);throw new TypeError("You provided "+
(null!=c&&"object"===typeof c?"an invalid object":"'"+c+"'")+" where a stream was expected. You can provide an Observable, Promise, Array, or Iterable.");},Eb={},Ka=function(){function c(a){this.resultSelector=a}c.prototype.call=function(a,b){return b.subscribe(new ed(a,this.resultSelector))};return c}(),ed=function(c){function a(b,a){b=c.call(this,b)||this;b.resultSelector=a;b.active=0;b.values=[];b.observables=[];return b}d(a,c);a.prototype._next=function(b){this.values.push(Eb);this.observables.push(b)};
...
b)}catch(f){this.destination.error(f);return}this.destination.error(b)};a.prototype._complete=function(){try{this._tapComplete.call(this._context)}catch(b){this.destination.error(b);return}return this.destination.complete()};return a}(q),qa=function(c){void 0===c&&(c=pc);return ob({hasValue:!1,next:function(){this.hasValue=!0},complete:function(){if(!this.hasValue)throw c();}})},qc=function(){function c(a){this.total=a;if(0>this.total)throw new S;}c.prototype.call=function(a,b){return b.subscribe(new Ud(a,
...
function(){this.closingNotification&&this.closingNotification.unsubscribe()};a.prototype.openWindow=function(a){void 0===a&&(a=null);a&&(this.remove(a),a.unsubscribe());(a=this.window)&&a.complete();a=this.window=new y;this.destination.next(a);a=m(this.closingSelector)();a===p?(a=p.e,this.destination.error(a),this.window.error(a)):this.add(this.closingNotification=u(this,a))};return a}(v),sf=function(){function c(a,b){this.observables=a;this.project=b}c.prototype.call=function(a,b){return b.subscribe(new rf(a,
this.observables,this.project))};return c}(),rf=function(c){function a(a,d,g){a=c.call(this,a)||this;a.observables=d;a.project=g;a.toRespond=[];g=d.length;a.values=Array(g);for(var b=0;b<g;b++)a.toRespond.push(b);for(b=0;b<g;b++){var f=d[b];a.add(u(a,f,f,b))}return a}d(a,c);a.prototype.notifyNext=function(a,c,d,e,h){this.values[d]=c;a=this.toRespond;0<a.length&&(d=a.indexOf(d),-1!==d&&a.splice(d,1))};a.prototype.notifyComplete=function(){};a.prototype._next=function(a){0===this.toRespond.length&&
(a=[a].concat(this.values),this.project?this._tryProject(a):this.destination.next(a))};a.prototype._tryProject=function(a){var b;try{b=this.project.apply(this,a)}catch(g){this.destination.error(g);return}this.destination.next(b)};return a}(v),tf=Object.freeze({audit:jb,auditTime:function(c,a){void 0===a&&(a=D);return jb(function(){return gb(c,a)})},buffer:function(c){return function(a){return a.lift(new nd(c))}},bufferCount:function(c,a){void 0===a&&(a=null);return function(b){return b.lift(new qd(c,
a))}},bufferTime:function(c){var a=arguments.length,b=D;C(arguments[arguments.length-1])&&(b=arguments[arguments.length-1],a--);var d=null;2<=a&&(d=arguments[1]);var g=Number.POSITIVE_INFINITY;3<=a&&(g=arguments[2]);return function(a){return a.lift(new sd(c,d,g,b))}},bufferToggle:function(c,a){return function(b){return b.lift(new vd(c,a))}},bufferWhen:function(c){return function(a){return a.lift(new xd(c))}},catchError:function(c){return function(a){var b=new zd(c);a=a.lift(b);return b.caught=a}},
combineAll:function(c){return function(a){return a.lift(new Ka(c))}},combineLatest:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var b=null;"function"===typeof c[c.length-1]&&(b=c.pop());1===c.length&&E(c[0])&&(c=c[0].slice());return function(a){return a.lift.call(M([a].concat(c)),new Ka(b))}},concat:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){return a.lift.call(O.apply(void 0,[a].concat(c)))}},concatAll:$a,concatMap:mb,concatMapTo:function(c,
a){return mb(function(){return c},a)},count:function(c){return function(a){return a.lift(new Bd(c,a))}},debounce:function(c){return function(a){return a.lift(new Dd(c))}},debounceTime:function(c,a){void 0===a&&(a=D);return function(b){return b.lift(new Fd(c,a))}},defaultIfEmpty:fa,delay:function(c,a){void 0===a&&(a=D);var b=c instanceof Date&&!isNaN(+c)?+c-a.now():Math.abs(c);return function(c){return c.lift(new Id(b,a))}},delayWhen:function(c,a){return a?function(b){return(new Md(b,a)).lift(new Gb(c))}:
function(a){return a.lift(new Gb(c))}},dematerialize:function(){return function(c){return c.lift(new Od)}},distinct:function(c,a){return function(b){return b.lift(new Qd(c,a))}},distinctUntilChanged:nb,distinctUntilKeyChanged:function(c,a){return nb(function(b,d){return a?a(b[c],d[c]):b[c]===d[c]})},elementAt:function(c,a){if(0>c)throw new S;var b=2<=arguments.length;return function(d){return d.pipe(ca(function(a,b){return b===c}),Da(1),b?fa(a):qa(function(){return new S}))}},endWith:function(){for(var c=
[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){var b=c[c.length-1];C(b)?c.pop():b=null;var d=c.length;return 1!==d||b?0<d?O(a,K(c,b)):O(a,I(b)):O(a,ua(c[0]))}},every:function(c,a){return function(b){return b.lift(new Wd(c,a,b))}},exhaust:function(){return function(c){return c.lift(new Yd)}},exhaustMap:pb,expand:function(c,a,b){void 0===a&&(a=Number.POSITIVE_INFINITY);void 0===b&&(b=void 0);a=1>(a||0)?Number.POSITIVE_INFINITY:a;return function(d){return d.lift(new ae(c,a,b))}},
filter:ca,finalize:function(c){return function(a){return a.lift(new ce(c))}},find:function(c,a){if("function"!==typeof c)throw new TypeError("predicate is not a function");return function(b){return b.lift(new Hb(c,b,!1,a))}},findIndex:function(c,a){return function(b){return b.lift(new Hb(c,b,!0,a))}},first:function(c,a){var b=2<=arguments.length;return function(d){return d.pipe(c?ca(function(a,b){return c(a,b,d)}):R,Da(1),b?fa(a):qa(function(){return new ga}))}},groupBy:function(c,a,b,d){return function(f){return f.lift(new Tc(c,
a,b,d))}},ignoreElements:function(){return function(c){return c.lift(new fe)}},isEmpty:function(){return function(c){return c.lift(new he)}},last:function(c,a){var b=2<=arguments.length;return function(d){return d.pipe(c?ca(function(a,b){return c(a,b,d)}):R,la(1),b?fa(a):qa(function(){return new ga}))}},map:G,mapTo:function(c){return function(a){return a.lift(new ke(c))}},materialize:function(){return function(c){return c.lift(new me)}},max:function(c){return na("function"===typeof c?function(a,b){return 0<
c(a,b)?a:b}:function(a,b){return a>b?a:b})},merge:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){return a.lift.call(eb.apply(void 0,[a].concat(c)))}},mergeAll:Aa,mergeMap:U,flatMap:U,mergeMapTo:function(c,a,b){void 0===b&&(b=Number.POSITIVE_INFINITY);if("function"===typeof a)return U(function(){return c},a,b);"number"===typeof a&&(b=a);return U(function(){return c},b)},mergeScan:function(c,a,b){void 0===b&&(b=Number.POSITIVE_INFINITY);return function(d){return d.lift(new pe(c,
a,b))}},min:function(c){return na("function"===typeof c?function(a,b){return 0>c(a,b)?a:b}:function(a,b){return a<b?a:b})},multicast:V,observeOn:function(c,a){void 0===a&&(a=0);return function(b){return b.lift(new Xc(c,a))}},onErrorResumeNext:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];1===c.length&&E(c[0])&&(c=c[0]);return function(a){return a.lift(new re(c))}},pairwise:function(){return function(c){return c.lift(new te)}},partition:function(c,a){return function(b){return[ca(c,
a)(b),ca(wc(c,a))(b)]}},pluck:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var b=c.length;if(0===b)throw Error("list of properties cannot be empty.");return function(a){return G(xc(c,b))(a)}},publish:function(c){return c?V(function(){return new y},c):V(new y)},publishBehavior:function(c){return function(a){return V(new zb(c))(a)}},publishLast:function(){return function(c){return V(new Z)(c)}},publishReplay:function(c,a,b,d){b&&"function"!==typeof b&&(d=b);var f="function"===
typeof b?b:void 0,e=new W(c,a,d);return function(a){return V(function(){return e},f)(a)}},race:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){1===c.length&&E(c[0])&&(c=c[0]);return a.lift.call(fb.apply(void 0,[a].concat(c)))}},reduce:na,repeat:function(c){void 0===c&&(c=-1);return function(a){return 0===c?I():0>c?a.lift(new Ib(-1,a)):a.lift(new Ib(c-1,a))}},repeatWhen:function(c){return function(a){return a.lift(new we(c))}},retry:function(c){void 0===c&&(c=
-1);return function(a){return a.lift(new ye(c,a))}},retryWhen:function(c){return function(a){return a.lift(new Ae(c,a))}},refCount:ta,sample:function(c){return function(a){return a.lift(new Ce(c))}},sampleTime:function(c,a){void 0===a&&(a=D);return function(b){return b.lift(new Ee(c,a))}},scan:ma,sequenceEqual:function(c,a){return function(b){return b.lift(new Ge(c,a))}},share:function(){return function(c){return ta()(V(zc)(c))}},shareReplay:function(c,a,b){void 0===c&&(c=Number.POSITIVE_INFINITY);
void 0===a&&(a=Number.MAX_VALUE);return function(d){return d.lift(Ac(c,a,b))}},single:function(c){return function(a){return a.lift(new Je(c,a))}},skip:function(c){return function(a){return a.lift(new Le(c))}},skipLast:function(c){return function(a){return a.lift(new Ne(c))}},skipUntil:function(c){return function(a){return a.lift(new Pe(c))}},skipWhile:function(c){return function(a){return a.lift(new Re(c))}},startWith:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){var b=
c[c.length-1];C(b)?c.pop():b=null;var d=c.length;return 1!==d||b?0<d?O(K(c,b),a):O(I(b),a):O(ua(c[0]),a)}},subscribeOn:function(c,a){void 0===a&&(a=0);return function(b){return b.lift(new Te(c,a))}},switchAll:function(){return ha(R)},switchMap:ha,switchMapTo:function(c,a){return a?ha(function(){return c},a):ha(function(){return c})},take:Da,takeLast:la,takeUntil:function(c){return function(a){return a.lift(new We(c))}},takeWhile:function(c){return function(a){return a.lift(new Ye(c))}},tap:ob,throttle:function(c,
a){void 0===a&&(a=Jb);return function(b){return b.lift(new $e(c,a.leading,a.trailing))}},throttleTime:function(c,a,b){void 0===a&&(a=D);void 0===b&&(b=Jb);return function(d){return d.lift(new bf(c,a,b.leading,b.trailing))}},throwIfEmpty:qa,timeInterval:function(c){void 0===c&&(c=D);return function(a){return Ba(function(){return a.pipe(ma(function(a,d){a=a.current;return{value:d,current:c.now(),last:a}},{current:c.now(),value:void 0,last:void 0}),G(function(a){return new cf(a.value,a.current-a.last)}))})}},
timeout:function(c,a){void 0===a&&(a=D);return qb(c,wa(new xa),a)},timeoutWith:qb,timestamp:function(c){void 0===c&&(c=D);return G(function(a){return new ef(a,c.now())})},toArray:function(){return na(Ec,[])},window:function(c){return function(a){return a.lift(new gf(c))}},windowCount:function(c,a){void 0===a&&(a=0);return function(b){return b.lift(new jf(c,a))}},windowTime:function(c,a,b,d){var f=D,e=null,h=Number.POSITIVE_INFINITY;C(d)&&(f=d);C(b)?f=b:ba(b)&&(h=b);C(a)?f=a:ba(a)&&(e=a);return function(a){return a.lift(new lf(c,
e,h,f))}},windowToggle:function(c,a){return function(b){return b.lift(new of(c,a))}},windowWhen:function(c){return function(a){return a.lift(new qf(c))}},withLatestFrom:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){var b;"function"===typeof c[c.length-1]&&(b=c.pop());return a.lift(new sf(c,b))}},zip:function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];return function(a){return a.lift.call(hb.apply(void 0,[a].concat(c)))}},zipAll:function(c){return function(a){return a.lift(new ib(c))}}}),
ka=function(){return function(c,a){void 0===a&&(a=Number.POSITIVE_INFINITY);this.subscribedFrame=c;this.unsubscribedFrame=a}}(),Kb=function(){function c(){this.subscriptions=[]}c.prototype.logSubscribedFrame=function(){this.subscriptions.push(new ka(this.scheduler.now()));return this.subscriptions.length-1};c.prototype.logUnsubscribedFrame=function(a){var b=this.subscriptions;b[a]=new ka(b[a].subscribedFrame,this.scheduler.now())};return c}(),La=function(c){function a(a,d){var b=c.call(this,function(a){var b=
this,c=b.logSubscribedFrame(),d=new w;d.add(new w(function(){b.logUnsubscribedFrame(c)}));b.scheduleMessages(a);return d})||this;b.messages=a;b.subscriptions=[];b.scheduler=d;return b}d(a,c);a.prototype.scheduleMessages=function(a){for(var b=this.messages.length,c=0;c<b;c++){var d=this.messages[c];a.add(this.scheduler.schedule(function(a){a.message.notification.observe(a.subscriber)},d.frame,{message:d,subscriber:a}))}};return a}(r);sb(La,[Kb]);var Lb=function(c){function a(a,d){var b=c.call(this)||
this;b.messages=a;b.subscriptions=[];b.scheduler=d;return b}d(a,c);a.prototype._subscribe=function(a){var b=this,d=b.logSubscribedFrame(),e=new w;e.add(new w(function(){b.logUnsubscribedFrame(d)}));e.add(c.prototype._subscribe.call(this,a));return e};a.prototype.setup=function(){for(var a=this,c=a.messages.length,d=0;d<c;d++)(function(){var b=a.messages[d];a.scheduler.schedule(function(){b.notification.observe(a)},b.frame)})()};return a}(y);sb(Lb,[Kb]);var uf=function(c){function a(a){var b=c.call(this,
Ja,750)||this;b.assertDeepEqual=a;b.hotObservables=[];b.coldObservables=[];b.flushTests=[];b.runMode=!1;return b}d(a,c);a.prototype.createTime=function(b){b=b.indexOf("|");if(-1===b)throw Error('marble diagram for time should have a completion marker "|"');return b*a.frameTimeFactor};a.prototype.createColdObservable=function(b,c,d){if(-1!==b.indexOf("^"))throw Error('cold observable cannot have subscription offset "^"');if(-1!==b.indexOf("!"))throw Error('cold observable cannot have unsubscription marker "!"');
b=a.parseMarbles(b,c,d,void 0,this.runMode);b=new La(b,this);this.coldObservables.push(b);return b};a.prototype.createHotObservable=function(b,c,d){if(-1!==b.indexOf("!"))throw Error('hot observable cannot have unsubscription marker "!"');b=a.parseMarbles(b,c,d,void 0,this.runMode);b=new Lb(b,this);this.hotObservables.push(b);return b};a.prototype.materializeInnerObservable=function(a,c){var b=this,d=[];a.subscribe(function(a){d.push({frame:b.frame-c,notification:A.createNext(a)})},function(a){d.push({frame:b.frame-
...
d)})}}};a.prototype.flush=function(){for(var a=this,d=this.hotObservables;0<d.length;)d.shift().setup();c.prototype.flush.call(this);this.flushTests=this.flushTests.filter(function(b){return b.ready?(a.assertDeepEqual(b.actual,b.expected),!1):!0})};a.parseMarblesAsSubscriptions=function(a,c){var b=this;void 0===c&&(c=!1);if("string"!==typeof a)return new ka(Number.POSITIVE_INFINITY);for(var d=a.length,f=-1,e=Number.POSITIVE_INFINITY,h=Number.POSITIVE_INFINITY,l=0,m=function(d){var g=l,k=function(a){g+=
a*b.frameTimeFactor},m=a[d];switch(m){case " ":c||k(1);break;case "-":k(1);break;case "(":f=l;k(1);break;case ")":f=-1;k(1);break;case "^":if(e!==Number.POSITIVE_INFINITY)throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");e=-1<f?f:l;k(1);break;case "!":if(h!==Number.POSITIVE_INFINITY)throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");h=-1<f?f:l;break;default:if(c&&m.match(/^[0-9]$/)&&
(0===d||" "===a[d-1])){var t=a.slice(d).match(/^([0-9]+(?:\.[0-9]+)?)(ms|s|m) /);if(t){d+=t[0].length-1;var m=parseFloat(t[1]),p=void 0;switch(t[2]){case "ms":p=m;break;case "s":p=1E3*m;break;case "m":p=6E4*m}k(p/n.frameTimeFactor);break}}throw Error("there can only be '^' and '!' markers in a subscription marble diagram. Found instead '"+m+"'.");}l=g;q=d},n=this,q,p=0;p<d;p++)m(p),p=q;return 0>h?new ka(e):new ka(e,h)};a.parseMarbles=function(a,c,d,e,h){var b=this;void 0===e&&(e=!1);void 0===h&&(h=
!1);if(-1!==a.indexOf("!"))throw Error('conventional marble diagrams cannot have the unsubscription marker "!"');for(var f=a.length,g=[],k=h?a.replace(/^[ ]+/,"").indexOf("^"):a.indexOf("^"),l=-1===k?0:k*-this.frameTimeFactor,m="object"!==typeof c?function(a){return a}:function(a){return e&&c[a]instanceof La?c[a].messages:c[a]},p=-1,k=function(c){var f=l,e=function(a){f+=a*b.frameTimeFactor},k=void 0,t=a[c];switch(t){case " ":h||e(1);break;case "-":e(1);break;case "(":p=l;e(1);break;case ")":p=-1;
e(1);break;case "|":k=A.createComplete();e(1);break;case "^":e(1);break;case "#":k=A.createError(d||"error");e(1);break;default:if(h&&t.match(/^[0-9]$/)&&(0===c||" "===a[c-1])){var r=a.slice(c).match(/^([0-9]+(?:\.[0-9]+)?)(ms|s|m) /);if(r){c+=r[0].length-1;var t=parseFloat(r[1]),B=void 0;switch(r[2]){case "ms":B=t;break;case "s":B=1E3*t;break;case "m":B=6E4*t}e(B/n.frameTimeFactor);break}}k=A.createNext(m(t));e(1)}k&&g.push({frame:-1<p?p:l,notification:k});l=f;q=c},n=this,q,r=0;r<f;r++)k(r),r=q;
return g};a.prototype.run=function(b){var c=a.frameTimeFactor,d=this.maxFrames;a.frameTimeFactor=1;this.maxFrames=Number.POSITIVE_INFINITY;this.runMode=!0;Y.delegate=this;var e={cold:this.createColdObservable.bind(this),hot:this.createHotObservable.bind(this),flush:this.flush.bind(this),expectObservable:this.expectObservable.bind(this),expectSubscriptions:this.expectSubscriptions.bind(this)};try{var h=b(e);this.flush();return h}finally{a.frameTimeFactor=c,this.maxFrames=d,this.runMode=!1,Y.delegate=
void 0}};return a}(Db),vf=Object.freeze({TestScheduler:uf}),wf="undefined"!==typeof self&&"undefined"!==typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope&&self,xf="undefined"!==typeof global&&global,F="undefined"!==typeof window&&window||xf||wf;if(!F)throw Error("RxJS could not find any global context (window, self, global)");var Nc=G(function(c,a){return c.response}),X=function(c){function a(a){var b=c.call(this)||this,d={async:!0,createXHR:function(){var a;if(this.crossDomain)if(F.XMLHttpRequest)a=
new F.XMLHttpRequest;else if(F.XDomainRequest)a=new F.XDomainRequest;else throw Error("CORS is not supported by your browser");else if(F.XMLHttpRequest)a=new F.XMLHttpRequest;else{var b=void 0;try{for(var c=["Msxml2.XMLHTTP","Microsoft.XMLHTTP","Msxml2.XMLHTTP.4.0"],d=0;3>d;d++)try{b=c[d];new F.ActiveXObject(b);break}catch(t){}a=new F.ActiveXObject(b)}catch(t){throw Error("XMLHttpRequest is not supported by your browser");}}return a},crossDomain:!0,withCredentials:!1,headers:{},method:"GET",responseType:"json",
timeout:0};if("string"===typeof a)d.url=a;else for(var e in a)a.hasOwnProperty(e)&&(d[e]=a[e]);b.request=d;return b}d(a,c);a.prototype._subscribe=function(a){return new yf(a,this.request)};a.create=function(){var b=function(b){return new a(b)};b.get=Hc;b.post=Ic;b.delete=Jc;b.put=Kc;b.patch=Lc;b.getJSON=Mc;return b}();return a}(r),yf=function(c){function a(a,d){a=c.call(this,a)||this;a.request=d;a.done=!1;var b=d.headers=d.headers||{};d.crossDomain||b["X-Requested-With"]||(b["X-Requested-With"]="XMLHttpRequest");
"Content-Type"in b||F.FormData&&d.body instanceof F.FormData||"undefined"===typeof d.body||(b["Content-Type"]="application/x-www-form-urlencoded; charset\x3dUTF-8");d.body=a.serializeBody(d.body,d.headers["Content-Type"]);a.send();return a}d(a,c);a.prototype.next=function(a){this.done=!0;var b=this.destination;a=new Mb(a,this.xhr,this.request);a.response===p?b.error(p.e):b.next(a)};a.prototype.send=function(){var a=this.request,c=this.request,d=c.user,e=c.method,h=c.url,l=c.async,n=c.password,q=c.headers,
c=c.body,t=m(a.createXHR).call(a);if(t===p)this.error(p.e);else{this.xhr=t;this.setupEvents(t,a);d=d?m(t.open).call(t,e,h,l,d,n):m(t.open).call(t,e,h,l);if(d===p)return this.error(p.e),null;l&&(t.timeout=a.timeout,t.responseType=a.responseType);"withCredentials"in t&&(t.withCredentials=!!a.withCredentials);this.setHeaders(t,q);d=c?m(t.send).call(t,c):m(t.send).call(t);if(d===p)return this.error(p.e),null}return t};a.prototype.serializeBody=function(a,c){if(!a||"string"===typeof a||F.FormData&&a instanceof
F.FormData)return a;if(c){var b=c.indexOf(";");-1!==b&&(c=c.substring(0,b))}switch(c){case "application/x-www-form-urlencoded":return Object.keys(a).map(function(b){return encodeURIComponent(b)+"\x3d"+encodeURIComponent(a[b])}).join("\x26");case "application/json":return JSON.stringify(a);default:return a}};a.prototype.setHeaders=function(a,c){for(var b in c)c.hasOwnProperty(b)&&a.setRequestHeader(b,c[b])};a.prototype.setupEvents=function(a,c){function b(a){var c=b.subscriber,d=b.progressSubscriber,
e=b.request;d&&d.error(a);a=new Nb(this,e);a.response===p?c.error(p.e):c.error(a)}function d(a){}function e(a){var b=e.subscriber,c=e.progressSubscriber,d=e.request;if(4===this.readyState){var f=1223===this.status?204:this.status,g="text"===this.responseType?this.response||this.responseText:this.response;0===f&&(f=g?200:0);400>f?(c&&c.complete(),b.next(a),b.complete()):(c&&c.error(a),a=new ra("ajax error "+f,this,d),a.response===p?b.error(p.e):b.error(a))}}var f=c.progressSubscriber;a.ontimeout=b;
b.request=c;b.subscriber=this;b.progressSubscriber=f;if(a.upload&&"withCredentials"in a){if(f){var h;h=function(a){h.progressSubscriber.next(a)};F.XDomainRequest?a.onprogress=h:a.upload.onprogress=h;h.progressSubscriber=f}var l;l=function(a){var b=l.progressSubscriber,c=l.subscriber,d=l.request;b&&b.error(a);a=new ra("ajax error",this,d);a.response===p?c.error(p.e):c.error(a)};a.onerror=l;l.request=c;l.subscriber=this;l.progressSubscriber=f}a.onreadystatechange=d;d.subscriber=this;d.progressSubscriber=
f;d.request=c;a.onload=e;e.subscriber=this;e.progressSubscriber=f;e.request=c};a.prototype.unsubscribe=function(){var a=this.xhr;!this.done&&a&&4!==a.readyState&&"function"===typeof a.abort&&a.abort();c.prototype.unsubscribe.call(this)};return a}(q),Mb=function(){return function(c,a,b){this.originalEvent=c;this.xhr=a;this.request=b;this.status=a.status;this.responseType=a.responseType||b.responseType;this.response=ub(this.responseType,a)}}();tb.prototype=Object.create(Error.prototype);var ra=tb,Nb=
function(c,a){ra.call(this,"ajax timeout",c,a);this.name="AjaxTimeoutError";return this},zf=Object.freeze({ajax:X.create,AjaxResponse:Mb,AjaxError:ra,AjaxTimeoutError:Nb}),Af={url:"",deserializer:function(c){return JSON.parse(c.data)},serializer:function(c){return JSON.stringify(c)}},Ob=function(c){function a(a,d){var b=c.call(this)||this;if(a instanceof r)b.destination=d,b.source=a;else{d=b._config=Pc({},Af);b._output=new y;if("string"===typeof a)d.url=a;else for(var e in a)a.hasOwnProperty(e)&&
(d[e]=a[e]);if(!d.WebSocketCtor&&WebSocket)d.WebSocketCtor=WebSocket;else if(!d.WebSocketCtor)throw Error("no WebSocket constructor can be found");b.destination=new W}return b}d(a,c);a.prototype.lift=function(b){var c=new a(this._config,this.destination);c.operator=b;c.source=this;return c};a.prototype._resetState=function(){this._socket=null;this.source||(this.destination=new W);this._output=new y};a.prototype.multiplex=function(a,c,d){var b=this;return new r(function(e){var f=m(a)();f===p?e.error(p.e):
b.next(f);var g=b.subscribe(function(a){var b=m(d)(a);b===p?e.error(p.e):b&&e.next(a)},function(a){return e.error(a)},function(){return e.complete()});return function(){var a=m(c)();a===p?e.error(p.e):b.next(a);g.unsubscribe()}})};a.prototype._connectSocket=function(){var a=this,c=this._config,d=c.WebSocketCtor,e=c.protocol,h=c.url,c=c.binaryType,l=this._output,n=null;try{this._socket=n=e?new d(h,e):new d(h),c&&(this._socket.binaryType=c)}catch(t){l.error(t);return}var r=new w(function(){a._socket=
null;n&&1===n.readyState&&n.close()});n.onopen=function(b){var c=a._config.openObserver;c&&c.next(b);b=a.destination;a.destination=q.create(function(b){1===n.readyState&&(b=m(a._config.serializer)(b),b===p?a.destination.error(p.e):n.send(b))},function(b){var c=a._config.closingObserver;c&&c.next(void 0);b&&b.code?n.close(b.code,b.reason):l.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));a._resetState()},
function(){var b=a._config.closingObserver;b&&b.next(void 0);n.close();a._resetState()});b&&b instanceof W&&r.add(b.subscribe(a.destination))};n.onerror=function(b){a._resetState();l.error(b)};n.onclose=function(b){a._resetState();var c=a._config.closeObserver;c&&c.next(b);b.wasClean?l.complete():l.error(b)};n.onmessage=function(b){b=m(a._config.deserializer)(b);b===p?l.error(p.e):l.next(b)}};a.prototype._subscribe=function(a){var b=this,c=this.source;if(c)return c.subscribe(a);this._socket||this._connectSocket();
this._output.subscribe(a);a.add(function(){var a=b._socket;0===b._output.observers.length&&(a&&1===a.readyState&&a.close(),b._resetState())});return a};a.prototype.unsubscribe=function(){var a=this.source,d=this._socket;d&&1===d.readyState&&(d.close(),this._resetState());c.prototype.unsubscribe.call(this);a||(this.destination=new W)};return a}(Fa),Bf=Object.freeze({webSocket:function(c){return new Ob(c)},WebSocketSubject:Ob});e.operators=tf;e.testing=vf;e.ajax=zf;e.webSocket=Bf;e.Observable=r;e.ConnectableObservable=
yb;e.GroupedObservable=Ga;e.observable=aa;e.Subject=y;e.BehaviorSubject=zb;e.ReplaySubject=W;e.AsyncSubject=Z;e.asapScheduler=pa;e.asyncScheduler=D;e.queueScheduler=Ab;e.animationFrameScheduler=cd;e.VirtualTimeScheduler=Db;e.VirtualAction=Ja;e.Scheduler=Ha;e.Subscription=w;e.Subscriber=q;e.Notification=A;e.pipe=N;e.noop=z;e.identity=R;e.isObservable=function(c){return!!c&&(c instanceof r||"function"===typeof c.lift&&"function"===typeof c.subscribe)};e.ArgumentOutOfRangeError=S;e.EmptyError=ga;e.ObjectUnsubscribedError=
J;e.UnsubscriptionError=ea;e.TimeoutError=xa;e.bindCallback=Qa;e.bindNodeCallback=Ra;e.combineLatest=function(){for(var c=[],a=0;a<arguments.length;a++)c[a]=arguments[a];var b=a=null;C(c[c.length-1])&&(b=c.pop());"function"===typeof c[c.length-1]&&(a=c.pop());1===c.length&&E(c[0])&&(c=c[0]);return K(c,b).lift(new Ka(a))};e.concat=O;e.defer=Ba;e.empty=I;e.forkJoin=ab;e.from=M;e.fromEvent=bb;e.fromEventPattern=db;e.generate=function(c,a,b,d,e){var f,g;1==arguments.length?(g=c.initialState,a=c.condition,
b=c.iterate,f=c.resultSelector||R,e=c.scheduler):void 0===d||C(d)?(g=c,f=R,e=d):(g=c,f=d);return new r(function(c){var d=g;if(e)return e.schedule(cc,0,{subscriber:c,iterate:b,condition:a,resultSelector:f,state:d});do{if(a){var h=void 0;try{h=a(d)}catch(t){c.error(t);break}if(!h){c.complete();break}}h=void 0;try{h=f(d)}catch(t){c.error(t);break}c.next(h);if(c.closed)break;try{d=b(d)}catch(t){c.error(t);break}}while(1)})};e.iif=function(c,a,b){void 0===a&&(a=Q);void 0===b&&(b=Q);return Ba(function(){return c()?
a:b})};e.interval=function(c,a){void 0===c&&(c=0);void 0===a&&(a=D);if(!ba(c)||0>c)c=0;a&&"function"===typeof a.schedule||(a=D);return new r(function(b){b.add(a.schedule(dc,c,{subscriber:b,counter:0,period:c}));return b})};e.merge=eb;e.never=function(){return Fb};e.of=va;e.onErrorResumeNext=Ca;e.pairs=function(c,a){return a?new r(function(b){var d=Object.keys(c),e=new w;e.add(a.schedule(ec,0,{keys:d,index:0,subscriber:b,subscription:e,obj:c}));return e}):new r(function(a){for(var b=Object.keys(c),
d=0;d<b.length&&!a.closed;d++){var e=b[d];c.hasOwnProperty(e)&&a.next([e,c[e]])}a.complete()})};e.race=fb;e.range=function(c,a,b){void 0===c&&(c=0);void 0===a&&(a=0);return new r(function(d){var e=0,f=c;if(b)return b.schedule(gc,0,{index:e,count:a,start:c,subscriber:d});do{if(e++>=a){d.complete();break}d.next(f++);if(d.closed)break}while(1)})};e.throwError=wa;e.timer=gb;e.using=function(c,a){return new r(function(b){var d;try{d=c()}catch(B){b.error(B);return}var e;try{e=a(d)}catch(B){b.error(B);return}var h=
(e?M(e):Q).subscribe(b);return function(){h.unsubscribe();d&&d.unsubscribe()}})};e.zip=hb;e.EMPTY=Q;e.NEVER=Fb;e.config=H;Object.defineProperty(e,"__esModule",{value:!0})});